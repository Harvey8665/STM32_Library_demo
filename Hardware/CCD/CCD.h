...
硬件资源:开发板     线性CCD
         ...
         GND   —— GND
         PA1   —— AO1
         PA2   —— CLK    如需修改本引脚，则在下方修改#define TSL_CLK   P?out(?),然后到 ccd.c 文件修改Ccd_Init函数相关引脚的定义即可
         PA7   —— SI     如需修改本引脚，则在下方修改#define TSL_SI    P?out(?),然后到 ccd.c 文件修改Ccd_Init函数相关引脚的定义即可
*/
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////// 
